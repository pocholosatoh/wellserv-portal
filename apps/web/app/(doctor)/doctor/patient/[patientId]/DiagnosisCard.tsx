...
export default function DiagnosisCard({ consultationId }: { consultationId: string | null }) {
  ...
  return (
    <section className="rounded-xl border border-gray-200">
      ...
      <div className="p-4 space-y-4">
        {!canEdit ? (
          <div className="text-sm text-gray-600">Start the consultation to add diagnoses.</div>
        ) : (
          <>
            ...
            <div className="space-y-2">
              ...
              {picks.length === 0 && <div className="text-sm text-gray-600">No diagnoses yet.</div>}
            </div>
