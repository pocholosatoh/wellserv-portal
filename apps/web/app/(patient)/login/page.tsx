      ...
      <main style={page}>
        ...
        <div style={card}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "grid", gap: 12 }}>
            ...
            {/* Access Code */}
            <label htmlFor="pcode" style={label}>
              Access Code
            </label>
            <input
              id="pcode"
            ...
            <button
              ...
              disabled={
                loading || pid.trim() === "" || !consent || (needsCode && code.trim() === "")
              }
            >
              {loading ? (
                <span className="login-btn__content">
                  <span className="spinner" aria-hidden />
                  <span className="btn-text">Checking{".".repeat(loadingDots + 1)}</span>
                </span>
              ) : (
                "Continue"
              )}
            ...
            {loading && (
              ...
              >
                {isVeryLong
                  ? "Still verifying… please wait a moment longer or try again soon."
                  : "Hang tight, we’re verifying your access."}
              </div>
            )}

            <div style={footerNote}>Tip: Patient ID is not case sensitive.</div>
          </form>
        </div>
