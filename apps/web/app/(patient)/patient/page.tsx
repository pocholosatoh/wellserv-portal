...
import { formatShortDate, getInitials } from "@wellserv/core";
...
export default async function PatientHome() {
  ...
  const lastResultDate = formatShortDate(visits?.[0]?.date_of_test) || "—";
  const lastRxDate = formatShortDate(lastRx?.created_at as string | null | undefined) || "—";
